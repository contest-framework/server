...
impl UserError {
  ...
  pub fn messages(&self) -> (String, String) {
    match self {
            ...
            UserError::FileNameNotAvailable => ("Filename is not known".into(), r#"To use the {{file}} placeholder in a variable, you need to choose either the "testFile" or "testFunction" action type that provides this data."#.into()),           UserError::FilesIsEmpty => (r#"The "files" field in your config file is empty"#.into(), String::new()),
            ...
            UserError::MissingLineFieldInCurrentOrAboveLineContent => ("missing \"line\" field".into(), String::new()),
