...
impl UserError {
  ...
  pub fn messages(&self) -> (String, String) {
    match self {
            ...
            UserError::LineNotAvailable => ("Line not available".into(), r#"To use the current line in a variable, you need to use the "testFunction" action type that provides this data."#.into()),
