...
impl UserError {
  ...
  pub fn messages(&self) -> (String, String) {
    match self {
            ...
            UserError::FileNameNotAvailable => ("Filename is not known".into(), r#"To use the filename in a variable, you need to choose either the "testFile" or "testFileLine" action type that provides this data."#.into()),           UserError::FilesIsEmpty => (r#"The "files" field in your config file is empty"#.into(), String::new()),
            ...
            UserError::LineNotAvailable => ("Line not available".into(), r#"To use the current line in a variable, you need to use the "testFileLine" action type that provides this data."#.into()),
